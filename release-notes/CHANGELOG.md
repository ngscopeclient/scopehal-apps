...
* PCIe: Added basic decoding for message TLPs (hex type and body but no upper layer)
* PCIe: Initial implementation of BDF decoding for destination addresses in configuration write TLPs (https://github.com/ngscopeclient/scopehal/issues/1030)
* Added --help and --version command line arguments (https://github.com/ngscopeclient/scopehal-apps/pull/931)
